...
def extract_coordinates(caption, pattern = '(X|x)+:(\S+) (¥|Y)+:(\S+) (Z|2|7)+:(\S+)',
                        indices = [2, 4, 6, 7],
                        possible_matches = [],
                        fixes={'\n': ''}):
        """
...
class UtilsTester(unittest.TestCase):
    ...
    """
    def setUp(self):
        import urllib, imutils
        url = 'https://gist.github.com/blenzi/1cf8d14fd01494f7d9c0e34714f35c29/raw' # noqa: E501
